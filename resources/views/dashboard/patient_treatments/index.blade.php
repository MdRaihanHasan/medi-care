            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Patient Treatment List</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <table class="table mb-0 border-0 custom-table comman-table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $patientTreatment->patient->first_name }} {{ $patientTreatment->patient->first_name }}</td>
                                        ...
                                        {{-- <td>{{ $patientTreatment->created_at->format('d.m.Y') }}</td> --}}
                                        {{-- <td>{{ $patientTreatment->updated_at->format('d.m.Y') }}</td> --}}
                                        <td class="text-end">
