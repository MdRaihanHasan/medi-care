                                ...
                                <div class="col">
                                    ...
                                    <div class="doctor-table-blk">
                                        ...
                                        <div class="doctor-search-blk">
                                            ...
                                            <div class="add-group">
                                                <a href="{{ route('dashboard.wards.create') }}"
                            ...
                            <table class="table mb-0 border-0 custom-table comman-table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $ward->name }}</td>
                                        <td>{{ $ward->capacity }}</td>
                                        <td>{{ $ward->rooms->count() }}</td> <!-- Total rooms in the ward -->
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    {{-- <a href="{{ route('wards.edit', $ward->id) }}" class="dropdown-item">
                                                        <i class="fa fa-edit m-r-5"></i> Edit
                                                    </a> --}}
                                                    <form action="{{ route('dashboard.wards.destroy', $ward->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
