                    ...
                    <div class="card-body">
                                ...
                                <div class="col">
                                    ...
                                    <div class="doctor-table-blk">
                                        ...
                                        <div class="doctor-search-blk">
                                            ...
                                            <div class="add-group">
                                                <a href="{{ route('dashboard.medicine-categories.create') }}"
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table mb-0 border-0 custom-table comman-table datatable">
                                ...
                                <tbody>
                                    @foreach($categories as $roomType)
                                    <tr>
                                        <td>
                                            <div class="form-check check-tables">
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <form action="{{ route('dashboard.medicine-categories.destroy', $roomType->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
