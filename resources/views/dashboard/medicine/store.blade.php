                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-xl-6">
                                    <div class="input-block local-forms">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="Enter medicine name" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-xl-6">
                                    <div class="input-block local-forms">
                                        ...
                                        <select name="medicine_category_id" class="form-control" required>
                                ...
                                <div class="col-12 col-md-6 col-xl-6">
                                    <div class="input-block local-forms">
                                        <label>Dosage Form <span class="login-danger">*</span></label>
                                        <input class="form-control" type="text" name="dosage_form" placeholder="Enter dosage form (e.g., Tablet, Syrup)" required>
                                    </div>
                                </div>

                                <div class="col-12 col-md-6 col-xl-6">
                                    <div class="input-block local-forms">
                                        <label>Strength <span class="login-danger">*</span></label>
                                        <input class="form-control" type="text" name="strength" placeholder="Enter strength (e.g., 500mg)" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-xl-6">
                                    <div class="input-block local-forms">
                                        ...
                                        <input class="form-control" type="number" name="stock" placeholder="Enter stock quantity" required>
                                    </div>
                                </div>
