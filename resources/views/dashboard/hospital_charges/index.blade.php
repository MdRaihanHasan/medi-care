    ...
    <div class="content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">hospital-charge </a></li>
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <div class="doctor-table-blk">
                                        <h3>hospital-charge List</h3>
                                        <div class="doctor-search-blk">
                                            @include('components.search-component', ['searchTerm' => $searchTerm])
                                            <div class="add-group">
                                                <a href="{{ route('dashboard.hospital-charge.create') }}"
                            ...
                            <table class="table mb-0 border-0 custom-table comman-table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check check-tables">
                                                <input class="form-check-input" type="checkbox" value="{{ $charge->id }}">
                                            </div>
                                        </td>
                                        <td>{{ $charge->name }}</td>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    {{-- <a href="{{ route('dashboard.hospital_charges.edit', $charge->id) }}" class="dropdown-item">
                                                        <i class="fa fa-edit m-r-5"></i> Edit
                                                    </a> --}}
                                                    <form action="{{ route('dashboard.hospital-charge.destroy', $charge->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
