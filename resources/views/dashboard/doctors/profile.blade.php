                    ...
                    <div class="profile-view">
                        <div class="profile-img-wrap">
                            <div class="profile-img">
                                <a href="#"><img class="avatar" src="{{ asset('assets/img/doctor-03.jpg') }}"
                                        alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        <h3 class="mb-0 user-name m-t-0">Cristina Groves</h3>
                                    ...
                                    <ul class="personal-info">
                                        ...
                                        <li>
                                            ...
                                            <span class="text"><a href=""><span class="__cf_email__"
                                                        data-cfemail="f390819a80879a9d9294819c859680b3968b929e839f96dd909c9e">[email&#160;protected]</span></a></span>
                                        </li>
                                        <li>
