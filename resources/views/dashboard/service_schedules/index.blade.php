            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">service_schedules List</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <div class="doctor-table-blk">
                                        <h3>service_schedules List</h3>
                                        <div class="doctor-search-blk">
                                            @include('components.search-component', ['searchTerm' => $searchTerm])
                                            <div class="add-group">
                                                <a href="{{ route('dashboard.service_schedules.create') }}"
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="{{ route('dashboard.service_schedules.edit', $schedule->id) }}" class="dropdown-item">
                                                        <i class="fa fa-edit m-r-5"></i> Edit
                                                    </a>
                                                    <form action="{{ route('dashboard.service_schedules.destroy', $schedule->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
